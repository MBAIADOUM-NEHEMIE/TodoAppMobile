...
class EditeTaskFormDialog extends StatefulWidget {
  ...
  const EditeTaskFormDialog({super.key, this.taskToEdit});

  @override
  EditeTaskFormDialogState createState() => EditeTaskFormDialogState();
}

class EditeTaskFormDialogState extends State<EditeTaskFormDialog> {
